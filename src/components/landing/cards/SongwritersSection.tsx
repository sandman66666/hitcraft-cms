        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          <div className="lg:col-span-2 mb-[-5]">
            ...
            <EditableText
              ...
              className="text-4xl sm:text-5xl lg:text-[72px] font-extralight leading-tight font-poppins bg-clip-text text-transparent bg-gradient-to-r from-[#8a44c8] to-[#df0c39] [text-shadow:1px_1px_4px_rgba(0,0,0,0.2)]"
              as="h3"
            />
          </div>
