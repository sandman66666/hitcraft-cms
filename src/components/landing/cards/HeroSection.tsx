    ...
    >
      ...
      <div className="text-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <EditableText
          ...
          className="text-xl sm:text-2xl lg:text-4xl font-light mb-16 text-white/80 max-w-4xl mx-auto animate-fade-in-delay leading-relaxed tracking-wide"
        />
        <div className="inline-flex flex-col items-center animate-fade-in-delay-2">
          <CTAButton 
            ...
            variant="light"
          />
          <p className="text-base text-gray-400 mt-6 font-light tracking-wide">{initialContent?.secondaryText || 'No credit card required • Try it free'}</p>
        </div>
      </div>
    </section>
  );
